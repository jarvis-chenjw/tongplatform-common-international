<template>
    <!-- 遮罩层 -->
    <div v-show="panel" class="mask" style="z-index: 99999;">
        <div class="container upload">
            ...
            <div class="btn-box">
                <button class="ivu-btn ivu-btn-ghost mr-l" type="button" @click="cancelCrop">取消</button>
                <button class="ivu-btn ivu-btn-primary" type="button" @click="crop">确定</button>
            </div>
        </div>
    </div>
</template>
<script type="text/javascript">
import Cropper from '../js/cropper-utils.js'
