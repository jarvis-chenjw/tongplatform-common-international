 ...
 * @since 2018-07-03
 */
import axiosUtils from "./ajax-utils-rest.js"
...
var _authClient = function () {
    ...
    var auth = {
        ...
        areaCode: cookies.getCookie("AREA_CODE") || INNO_CHINA_CONSTANTS.AREA_CODE,
        appId: cookies.getCookie("APP_ID"),
        projectId: cookies.getCookie("PROJECT_ID") || INNO_CHINA_CONSTANTS.PROJECT_ID,
        locale: cookies.getCookie('lang') || localStorage.getItem('lang') || "zh-CN"
    };
...
var _postJson = function (params) {
    ...
    var defaultParams = {
        ...
        headers: {
            ...
            "token": unescape(cookies.getCookie("token"))
        },
        isAsync: true
    };
    ...
    // rest请求路径
    ajaxParams["url"] = "/rest" + _getServiceUrl(ajaxParams);
