<template>
    <div class="mul-date-piker">
        <DatePicker :style="{width : datePickerWidth}" :options="startOptions" :type="dateType" :clearable="false" v-model="dateValue[0]" :value="dateValue[0]" @on-change="getValue" :editable="false" @on-open-change="openChange"></DatePicker>
    	<span style="display: inline-block;vertical-align: top;line-height: 32px;font-size: 14px;color: #80848f;">至</span>
    	<DatePicker :style="{width : datePickerWidth}" :options="endOptions" :type="dateType" :clearable="false" v-model="dateValue[1]" :value="dateValue[1]" @on-change="getValue" :editable="false" @on-open-change="openChange"></DatePicker>
