 ...
 * @since 2018-07-26
 */
import appAjax from './app-ajax.js';
const cropperConstructor = Lw.extend(require("../components/cropper.vue").default);

const OSS_UPLOAD_URL = INNO_CHINA_CONSTANTS.UPLOAD_URL;
